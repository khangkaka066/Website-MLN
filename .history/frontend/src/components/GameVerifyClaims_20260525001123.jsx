...
const buildQrSrc = (url) =>
  ...
  try {
    // Thay đổi URL này nếu backend của bạn có prefix khác, ví dụ: /api/game/stats
...
export const GameVerifyClaims = () => {
  ...
  const [loadingStats, setLoadingStats] = useState(true);
    ...
    const getStats = async () => {
      try {
        ...
        if (isMounted && data) {
          setStats(data);
          setLoadingStats(false); // Tắt loading sau khi có dữ liệu lần đầu
        }
      } catch (error) {
        console.error(error);
    ...
    // Thiết lập gọi lại mỗi 5 giây (5000ms)
  ...
  }, []); // Mảng rỗng là ĐÚNG trong trường hợp này vì ta không muốn effect chạy lại khi stats thay đổi
    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8">
                    {phase === "intro" && (
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
              {/* Cột trái: Intro Card (Giữ nguyên) */}
              <div className="lg:col-span-7">
